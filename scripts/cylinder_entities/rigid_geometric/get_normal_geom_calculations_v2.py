...
cylinder_position = np.array(cylinder_pos)  # Base position [0.0, 0.0, 0.05]
cylinder_height = 0.1
cylinder_quat = cylinder.get_quat()  # Quaternion [w, x, y, z]
...
# cam.stop_recording(save_to_filename='cylinder_normal_calc_video.mp4', fps=60)