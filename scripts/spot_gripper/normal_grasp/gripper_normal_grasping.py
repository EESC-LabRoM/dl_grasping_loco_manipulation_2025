...
spot_gripper.set_dofs_kp(np.array([100]*8))
spot_gripper.set_dofs_kv(np.array([1]*8))
...
increment_pos = [-0.02, 0, 0] # the fixed finger was colliding with the face 
spot_gripper.set_quat(quartenion)
spot_gripper.set_pos(face_world_centroid + 0.2 * face_world_normal + increment_pos)
current_qpos = spot_gripper.get_dofs_position()
# Performing grasp
print("\033[1;94m\nPerforming grasp. . . \033[0m")
perform_grasp()
